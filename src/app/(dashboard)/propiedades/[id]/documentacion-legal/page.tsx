...
export default async function DocumentacionLegalPage({
  params,
}: DocumentPageProps) {
    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">
          Escritura de propiedad, Nota Simple Registral, Referencia Catastral.
        </p>
      </div>

      <DocumentsSection listing={documentsData} folderType="documentacion-legal" />
    </div>
  );
}
