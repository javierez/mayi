...
export default async function HipotecaPage({ params }: DocumentPageProps) {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* Section header */}
      <div className="mb-6">
        <h3 className="mb-2 text-xl font-semibold text-gray-900">Hipoteca</h3>
        <p className="text-gray-600">
          Certificado de deuda pendiente, cancelación registral.
        </p>
      </div>

      <DocumentsSection listing={documentsData} folderType="hipoteca" />
    </div>
  );
}
