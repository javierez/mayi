...
const mockData: HojaEncargoDocumentData = {
  ...
  terms: {
    ...
    zonaCommissionPercentage: 1,
    zonaMinimumCommission: "500",
    allowSignage: true,
    allowVisits: true,
...
export default function NotaEncargoPlayground() {
  ...
  const sampleTerms = {
    ...
    min_commission: 2000,
    duration: 12,
    contractType: "exclusiva" as const,
    zonaCommissionPercentage: 1,
    zonaMinimumCommission: 500,
  ...
  return (
    <div className="min-h-screen bg-gray-100 p-8 print:m-0 print:bg-white print:p-0">
        ...
        <div className="mt-6 space-y-4">
          ...
          <div className="rounded-lg border bg-white p-4 shadow">
            ...
            {useRealData && (
              <p className="mt-2 text-xs text-green-600">
                ✅ Mostrando datos reales de la propiedad{" "}
                {testListingId.toString()}
              </p>
            )}
          </div>
          ...
          <div className="flex gap-4">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-md bg-green-600 px-4 py-2 text-white hover:bg-green-700 disabled:cursor-not-allowed disabled:opacity-50"
            >
              {isGenerating ? (
                <>
                  <Loader2 className="h-4 w-4 animate-spin" />
