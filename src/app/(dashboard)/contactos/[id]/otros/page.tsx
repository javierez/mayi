...
export default async function OtrosPage({ params }: DocumentPageProps) {
  ...
  const [contactData, documents] = await Promise.all([
    ...
    getContactOwnerDocumentsGroupedByListing(contactId, "otros"),
  ]);
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {/* Section header */}
      <div className="mb-6">
        <h3 className="mb-2 text-xl font-semibold text-gray-900">Otros</h3>
        <p className="text-gray-600">
          Otros documentos de las propiedades donde este contacto es
          propietario.
        </p>
      </div>
