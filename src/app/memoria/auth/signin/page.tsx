...
export default function MemoriaSignInPage() {
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-8">
        ...
        >
          ...
          <div className="space-y-2 text-center">
            <h1 className="text-xl font-medium text-gray-800">Iniciar sesión</h1>
            <p className="text-sm text-gray-500">
              Accede a tus recuerdos
            </p>
          </div>

          {/* Google Sign In - Bento style */}
          <motion.button
            whileTap={{ scale: 0.98 }}
