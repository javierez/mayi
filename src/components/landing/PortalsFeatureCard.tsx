...
export function PortalsFeatureCard({ portalStates, setPortalStates }: PortalsFeatureCardProps) {
  return (
    <motion.div
      key="portals"
        ...
        <div className="grid gap-6 lg:gap-8 lg:grid-cols-3">
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col gap-2 md:gap-3 pt-4">
              ...
              <button className="w-full rounded-lg bg-white px-4 md:px-6 py-2.5 md:py-3 text-sm font-medium text-gray-700 shadow-sm transition-all hover:shadow-md">
                Más información
              </button>
            </div>
          </div>
