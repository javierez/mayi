...
interface AIFeatureCardProps {
  ...
  aiSubCard: "descriptions" | "images";
  setAiSubCard: (value: "descriptions" | "images") => void;
  imageSliderPosition: number;
}

const IMAGE_FEATURES = {
  reforma: {
    before:
      "https://vesta-configuration-files.s3.us-east-1.amazonaws.com/marketing/SINREFORMAR.jpg",
    after:
      "https://vesta-configuration-files.s3.us-east-1.amazonaws.com/marketing/REFORMADA.jpg",
    stats: {
      time: "3.2 segundos",
      improvement: "Renovación virtual completa",
    },
  },
  planos: {
    before:
      "https://vesta-configuration-files.s3.us-east-1.amazonaws.com/marketing/PLANO2D.jpeg",
    after:
      "https://vesta-configuration-files.s3.us-east-1.amazonaws.com/marketing/PLANORENDER.jpeg",
    stats: {
      time: "4.5 segundos",
      improvement: "Render 3D fotorrealista",
    },
  },
};
    ...
    >
      <div className="rounded-2xl bg-gradient-to-br from-amber-50/50 to-rose-50/50 p-4 sm:p-6 md:p-8 shadow-lg">
        ...
        <div className="mb-4 sm:mb-6 flex gap-2 sm:gap-3">
          <button
            onClick={() => setAiSubCard("images")}
            className={cn(
              "flex-1 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-medium transition-all",
              aiSubCard === "images"
          ...
          <button
            onClick={() => setAiSubCard("descriptions")}
            className={cn(
              "flex-1 rounded-lg px-3 sm:px-4 py-2 sm:py-2.5 text-sm font-medium transition-all",
              aiSubCard === "descriptions"
                ? "bg-gradient-to-r from-amber-400 to-rose-400 text-white shadow-md"
                : "bg-white text-gray-600 hover:bg-gray-50 shadow-sm"
            )}
          >
            <PenTool className="mr-1.5 inline h-4 w-4" />
            Descripciones IA
          </button>
        </div>
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <p className="text-sm sm:text-base leading-relaxed text-gray-600">
                      Transforma tus fotografías de propiedades con inteligencia
                      artificial. Desde renovaciones virtuales hasta planos 3D
                      fotorrealistas.
                    </p>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="space-y-1.5 sm:space-y-2">
                      {[
                        "Renovación virtual de espacios",
                        "Planos 2D a renders 3D",
                        "Mejora de calidad de imagen",
                        "Corrección de iluminación",
                        "Ideal para carteles publicitarios",
                      ].map((item, index) => (
                  ...
                  <div className="flex flex-col gap-2 sm:gap-3 pt-2 sm:pt-4">
                    ...
                    <button
                      disabled
                      className="w-full rounded-lg bg-gray-100 px-4 sm:px-6 py-2.5 sm:py-3 text-sm font-medium text-gray-400 shadow-sm cursor-not-allowed"
                    >
                      Más información
                    </button>
                  </div>
                ...
                <div className="space-y-3 sm:space-y-4 lg:col-span-2">
                  ...
                  <div className="relative aspect-[16/9] w-full overflow-hidden rounded-lg bg-gray-100">
                    ...
                    <div
                      ...
                      style={{
                        clipPath: `inset(0 ${100 - imageSliderPosition}% 0 0)`,
                      }}
                    >
                      <Image
                        src={IMAGE_FEATURES.reforma.after}
                    ...
                    >
                      <div className="absolute top-1/2 flex h-6 w-6 -translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full border-2 border-white bg-gradient-to-r from-amber-400 to-rose-400 shadow-lg">
                  ...
                  <div className="relative aspect-[16/9] w-full overflow-hidden rounded-lg bg-gray-100">
                    ...
                    <div className="absolute inset-0">
                      <Image
                        src={IMAGE_FEATURES.planos.before}
                    ...
                    >
                      <Image
                        src={IMAGE_FEATURES.planos.after}
              ...
              <div className="grid gap-4 sm:gap-6 md:gap-8 lg:grid-cols-3">
                ...
                <div className="space-y-4 sm:space-y-6">
                  <div>
                    ...
                    <p className="text-sm sm:text-base leading-relaxed text-gray-600">
                      Genera descripciones atractivas y optimizadas para SEO con
                      inteligencia artificial. Destaca las mejores
                ...
                <div className="space-y-3 sm:space-y-4 lg:col-span-2">
                  ...
                  <div className="rounded-lg bg-white p-3 sm:p-4 shadow-sm">
                    ...
                    <div className="prose prose-sm sm:prose-base text-gray-700 max-w-none">
                      {descriptionText.split("\n\n").map((paragraph, index, arr) => {
                        ...
                        const isLastNonEmpty =
                          arr.filter((p) => p).length - 1 === index;
                        return (
                          <p
                            key={index}
                            className={
                              index > 0 ? "mt-2 leading-relaxed" : "leading-relaxed"
                            }
                          >
                            {paragraph}
                    ...
                    <div className="mt-3 sm:mt-4 flex flex-wrap items-center gap-2 sm:gap-3 text-xs sm:text-sm">
                      ...
                      <span className="text-gray-500">Score SEO: 94/100</span>
                    </div>
                  </div>
                </div>
              </div>
