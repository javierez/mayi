...
export function ToriParkDocument({ data }: Props) {
  ...
  // Get rental price from arrasAmount (which comes from listing_contact.offer)
  const rentalPrice = parseFloat(data.deal.arrasAmount);
  // Default security deposit to 100€
  ...
  const parseCheckInOut = (specialConditions?: string) => {
    ...
    const entradaMatch = specialConditions.match(/Entrada:\s*(\d{4}-\d{2}-\d{2})\s+(\d{2}:\d{2})/);
    const salidaMatch = specialConditions.match(/Salida:\s*(\d{4}-\d{2}-\d{2})\s+(\d{2}:\d{2})/);
        ...
        <div className="toripark-document mx-auto min-h-[1123px] max-w-[794px] px-10 py-6 font-sans text-[10pt] leading-[1.3] print:mx-0 print:min-h-0 print:max-w-none print:px-10 print:py-4">
          ...
          <div className="mb-4 print:mb-2">
            <div className="mb-3 flex items-center justify-between gap-8 pb-2 print:mb-2 print:pb-1">
              ...
              <div className="flex-1 space-y-0.5 text-right text-[9pt] leading-tight text-black">
                <div className="font-semibold">{agentName}</div>
                {taxId && <div>C.I.F: {taxId}</div>}
          ...
          <div className="mb-3 text-justify text-[9pt] leading-[1.4] print:mb-2">
            <p className="mb-2">
              El cliente se compromete al uso de las instalaciones de <strong>{agentName}</strong> de
              ...
              cualquier forma, que puedan causar daño a las mismas, así como a la imagen.
            </p>
            <p>
              Asimismo, el cliente abajo firmante se hace directa y exclusivamente
              responsable y exime de toda responsabilidad a <strong>{agentName}</strong>, de los daños
          ...
          <div className="mb-3 print:mb-2">
            <div className="mb-1 text-[10pt] font-bold">QUEDA TOTALMENTE PROHIBIDO:</div>
            <ul className="list-disc space-y-1 pl-5 text-[9pt] leading-[1.3]">
              <li>Salir a la calle con bebidas. No se pueden sacar vasos ni copas del local. En caso de sanción de cualquier tipo debida al comportamiento de cualquiera de los asistentes al evento, la responsabilidad íntegra será asumida por la persona firmante de este contrato, así como el pago de dicha sanción.</li>
              ...
              <li>Fumar en todo el recinto.</li>
              <li>Consumir comida o bebida en las zonas de juego infantiles, y poner comida o bebida encima de las mismas.</li>
              <li>En la zona de Juegos y en los parques de bolas, está totalmente prohibido la utilización de calzado y estar descalzos (sin calcetines), los usuarios deben llevar obligatoriamente calcetines.</li>
              <li>Que los mayores de 15 años utilicen las zonas de juego infantiles. El mal uso de estos conllevará la no devolución de la fianza.</li>
              <li><strong>COMER DENTRO DE LOS PARQUES DE BOLAS</strong></li>
              <li>Pegar cualquier adhesivo en las paredes, cristales de las ventanas y suelo, o clavar chinchetas, grapas, etc. así como tirar confeti, spray de serpentina o similar. Únicamente se podrá utilizar CINTA CARROCERA, despegándolo al quitar la decoración y antes de abandonar el local.</li>
          ...
          <div className="mb-3 text-justify text-[9pt] leading-[1.3] print:mb-2">
            <p className="mb-2">
          ...
          <div className="mb-3 print:mb-2">
            <div className="mb-1 text-[9pt] font-semibold">Dejar la sala vacía y recogida tal y como se entrega:</div>
            <ul className="list-disc space-y-0.5 pl-5 text-[9pt] leading-[1.3]">
              ...
              <li>Asegurarse de que las puertas quedan cerradas al abandonar.</li>
              <li><strong>DEJAR EL MOBILIARIO COLOCADO TAL CUAL SE ENCUENTRA A LA ENTRADA DE LA FIESTA.</strong></li>
            </ul>
          </div>

          {/* Section 5: Inventory */}
          <div className="mb-3 text-[9pt] leading-[1.3] print:mb-2">
            <p className="mb-1">El cliente abajo firmante se hará responsable de cualquier desperfecto del mobiliario, paredes, suelo, baños, etc.:</p>
          ...
          <div className="mb-3 text-justify text-[9pt] leading-[1.3] print:mb-2">
            <p className="mb-1">
              El <strong>{agentName}</strong> tiene que permanecer con las puertas cerradas durante toda la
            ...
            <ul className="list-disc space-y-0.5 pl-5">
              ...
              <li>A que durante toda la fiesta haya un adulto responsable, con capacidad para controlar el normal funcionamiento de la fiesta y el cumplimiento de estas normas, así como del cuidado de los niños en todos los espacios del <strong>{agentName}</strong>, en especial, en la zona infantil y baños.</li>
          ...
          <div className="mb-3 text-justify text-[9pt] leading-[1.3] print:mb-2">
            <p className="mb-1">
              El horario de disfrute del <strong>{agentName}</strong> será de <strong>17:00 a 21:00 horas</strong>.
            </p>
            <p className="mb-1">
            ...
            <p>
              <strong>El tiempo que exceda de la hora de salida, se cobrará como hora extra a 20
          ...
          <div className="mb-3 text-justify text-[9pt] leading-[1.3] print:mb-2">
            <p className="font-semibold">*POLÍTICA DE CANCELACIÓN O CAMBIOS DE FECHA</p>
            <p>
              Una vez reservada la fecha de alquiler de <strong>{agentName}</strong> y abonada la señal en
              concepto de reserva-fianza, no se devuelve el importe. Ver condiciones de pago en
              anexo informativo &quot;Como funcionamos&quot;.
            </p>
            <p className="mt-1">
              El equipo del <strong>{agentName}</strong> te agradece tu colaboración y te desea una feliz estancia.
            </p>
          </div>
          ...
          <div className="mb-3 text-[9pt] leading-[1.3] print:mb-2">
            <p className="mb-2">
              **El contratante deberá ser mayor de edad. La persona adulta firmante se compromete
              ...
              responsabilidad a <strong>{agentName}</strong> y se compromete a estar presente durante
              TODO el transcurso del evento.
            </p>

            {/* Landlord */}
            <div className="mb-2 rounded border border-black p-2">
          ...
          <div className="no-break mb-3 rounded border border-black p-3 text-[9pt] print:mb-2">
            <p className="mb-2 font-semibold">Mediante mi firma y como responsable doy mi conformidad y me comprometo al cumplimiento del presente contrato</p>
            ...
            <div className="mt-2 border-t border-black pt-2">
              <div><strong>IMPORTE ALQUILER:</strong> {formatCurrency(rentalPrice)}</div>
              <div><strong>FIANZA:</strong> {formatCurrency(securityDeposit)}</div>
            </div>
          </div>

          {/* Section 11: Legal Notice (ADVERTENCIA LEGAL) */}
          <div className="mb-3 text-justify text-[8pt] leading-[1.3] print:mb-2">
            <p className="mb-1 font-semibold">ADVERTENCIA LEGAL</p>
            <p className="mb-1">
              En virtud de las Leyes y Reglamentos vigentes y de aplicación a la Protección de
              Datos Personales, le informamos que en <strong>{agentName}</strong>, tratamos la información que nos
            ...
            <p className="mb-1">
              Usted tiene derecho a obtener confirmación sobre si en <strong>{agentName}</strong> estamos
              tratando sus datos personales, por tanto, tiene derecho a acceder, rectificar, suprimir,
              limitar, oponerse o a ejercer la portabilidad de sus datos.
            </p>
            <p>
          ...
          <div className="mb-3 text-center text-[9pt] font-semibold print:mb-2">
          ...
          {/* Signature Section */}
          <div className="signatures-section mt-4 print:mt-3">
            <div className="mb-3 text-justify text-[9pt] leading-relaxed print:mb-2">
          ...
          <div className="mt-4 print:mt-3">
            <p className="font-bold text-[10pt]">OBSERVACIONES:</p>
            {data.deal.specialConditions ? (
              <p className="mt-1 text-[9pt]">{data.deal.specialConditions}</p>
            ) : (
