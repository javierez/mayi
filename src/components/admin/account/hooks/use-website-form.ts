        ...
        if (result.success && result.data) {
          ...
          const formData = {
            ...
            heroProps: {
              ...
              backgroundVideo: result.data.heroProps?.backgroundVideo ?? "",
              backgroundType: result.data.heroProps?.backgroundType ?? "image",
              findPropertyButton:
            ...
            featuredProps: {
              title: result.data.featuredProps?.title ?? "Propiedades Destacadas",
              subtitle: result.data.featuredProps?.subtitle ?? "",
            },
            propertiesProps: {
              title: result.data.propertiesProps?.title ?? "Nuestras Propiedades",
              subtitle: result.data.propertiesProps?.subtitle ?? "",
              itemsPerPage: result.data.propertiesProps?.itemsPerPage ?? 12,
            },
            testimonialProps: {
              title: result.data.testimonialProps?.title ?? "Lo que dicen nuestros clientes",
              testimonials: result.data.testimonialProps?.testimonials ?? [],
            },
            contactProps: {
              title: result.data.contactProps?.title ?? "Contáctanos",
              subtitle: result.data.contactProps?.subtitle ?? "",
              messageForm: result.data.contactProps?.messageForm ?? true,
              address: result.data.contactProps?.address ?? true,
              phone: result.data.contactProps?.phone ?? true,
              mail: result.data.contactProps?.mail ?? true,
              schedule: result.data.contactProps?.schedule ?? true,
              map: result.data.contactProps?.map ?? true,
              offices: result.data.contactProps?.offices ?? [],
            },
            footerProps: result.data.footerProps ?? {
              companyName: "",
              description: "",
              socialLinks: {
                facebook: "",
            ...
            headProps: result.data.headProps ?? {
              customScripts: "",
              googleAnalytics: "",
              facebookPixel: "",
              googleTagManager: "",
