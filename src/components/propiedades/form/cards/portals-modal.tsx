...
export function PortalsModal({
  ...
  const [optimisticComments, addOptimisticComment] = useOptimistic(
    portalsComments
      ? portalsComments.map((c) => ({ ...c, status: "sent" as const }))
      : [],
    (
    ...
    <>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <DialogTitle>Portales</DialogTitle>
                  <button
                    type="button"
                    ...
                    aria-label="Información sobre portales"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3 p-3">
              ...
              <div className="relative flex-1">
                <Textarea
                  placeholder="Escribe una nota sobre los portales..."
                  value={newComment}
      ...
      <Dialog open={infoModalOpen} onOpenChange={setInfoModalOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle>Información sobre portales</DialogTitle>
          </DialogHeader>
          <p className="text-sm text-gray-600">
            ¿En qué portales se ha publicado la propiedad?
          </p>
