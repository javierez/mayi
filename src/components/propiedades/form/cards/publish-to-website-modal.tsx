...
export function PublishToWebsiteModal({
  open,
  onOpenChange,
  listingId,
  propertyId,
  ...
  const [optimisticComments, addOptimisticComment] = useOptimistic(
    publishToWebsiteComments
      ? publishToWebsiteComments.map((c) => ({ ...c, status: "sent" as const }))
      : [],
    (
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          aria-label="Información sobre publicación en web"
                        >
                          <Info className="h-4 w-4" />
                        </button>
                      </TooltipTrigger>
                      <TooltipContent side="right" className="max-w-xs">
                        <p className="text-xs">¿Está listo para publicarse en la página web?</p>
                      </TooltipContent>
                    </Tooltip>
                  </div>
                </div>
