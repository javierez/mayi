...
export function CartelModal({
  ...
  const [optimisticComments, addOptimisticComment] = useOptimistic(
    cartelComments
      ? cartelComments.map((c) => ({ ...c, status: "sent" as const }))
      : [],
    (
    ...
    <>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1">
                <div className="flex items-center gap-2">
                  <DialogTitle>Cartel</DialogTitle>
                  <button
                    type="button"
                    ...
                    aria-label="Información sobre cartel"
                  >
          ...
          <div className="space-y-4">
            ...
            <div className="flex space-x-3 p-3">
              ...
              <div className="relative flex-1">
                <Textarea
                  placeholder="Escribe una nota sobre el cartel..."
                  value={newComment}
      ...
      <Dialog open={infoModalOpen} onOpenChange={setInfoModalOpen}>
        <DialogContent className="max-w-sm">
          <DialogHeader>
            <DialogTitle>Información sobre cartel</DialogTitle>
          </DialogHeader>
          <p className="text-sm text-gray-600">
            ¿Se ha generado el cartel? ¿Está colocado?
          </p>
