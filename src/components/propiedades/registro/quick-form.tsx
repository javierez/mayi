      ...
      <div className="rounded-xl bg-white p-8 text-center shadow-sm">
        ...
        >
          ...
          <p className="mb-6 text-sm text-gray-600">
            Completa el formulario en menos de{" "}
            <span className="rounded-md bg-amber-50 px-2 py-1 font-semibold text-amber-600">
              3 minutos
            </span>{" "}
            y vuelve luego para completar todos los detalles.
          </p>
        </div>
