...
interface CommentWithStatus extends AppointmentCommentWithUser {
  status?: "sending" | "sent" | "error";
}

interface AppointmentCommentsProps {
  appointmentId: bigint;
  initialComments?: AppointmentCommentWithUser[];
  ...
  onAddComment: (
    comment: AppointmentCommentWithUser,
...
interface AppointmentCommentItemProps {
  ...
  startEditingComment: (comment: AppointmentCommentWithUser) => void;
  cancelEditing: () => void;
...
export function AppointmentComments({
  appointmentId,
  initialComments = [],
  currentUserId,
  currentUser,
  ...
  const startEditingComment = (comment: AppointmentCommentWithUser) => {
